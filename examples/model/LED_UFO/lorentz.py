...
SST2 = Lorentz(name = 'SST2',
               spins = [ 1, 1, 5 ],
               structure = 'Metric(-2,2003)*Metric(-1,1003) + Metric(-2,1003)*Metric(-1,2003)')
...
SSST1 = Lorentz(name = 'SSST1',
                spins = [ 1, 1, 1, 5 ],
                structure = 'Metric(-2,2004)*Metric(-1,1004) + Metric(-2,1004)*Metric(-1,2004)')
...
FFVT5 = Lorentz(name = 'FFVT5',
                spins = [ 2, 2, 3, 5 ],
                structure = '-(Gamma(2004,2,-1)*Metric(3,1004)*ProjM(-1,1)) - Gamma(1004,2,-1)*Metric(3,2004)*ProjM(-1,1) + Gamma(3,2,-1)*Metric(1004,2004)*ProjM(-1,1)')
...
FFVT7 = Lorentz(name = 'FFVT7',
                spins = [ 2, 2, 3, 5 ],
                structure = 'Gamma(2004,2,-1)*Metric(3,1004)*ProjM(-1,1) + Gamma(1004,2,-1)*Metric(3,2004)*ProjM(-1,1) - 2*Gamma(3,2,-1)*Metric(1004,2004)*ProjM(-1,1) + Gamma(2004,2,-1)*Metric(3,1004)*ProjP(-1,1) + Gamma(1004,2,-1)*Metric(3,2004)*ProjP(-1,1) - 2*Gamma(3,2,-1)*Metric(1004,2004)*ProjP(-1,1)')
...
SSSST1 = Lorentz(name = 'SSSST1',
                 spins = [ 1, 1, 1, 1, 5 ],
                 structure = 'Metric(-2,2005)*Metric(-1,1005) + Metric(-2,1005)*Metric(-1,2005)')
