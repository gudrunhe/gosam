...
Wmass = Parameter(name = 'Wmass',
               nature = 'internal',
               type = 'real',
               value = 'cmath.sqrt(Zmass**2/2+cmath.sqrt(Zmass**4/4-aEW*cmath.pi*Zmass**2/(Gf*cmath.sqrt(2))))',
               texname = '\\text{M_W}')
...
I1a33 = Parameter(name = 'I1a33',
                  nature = 'internal',
                  type = 'real',
                  value = '0+ fmd3x3*(Kq3x3)',
                  texname = '\\text{I1a33}')

I2a33 = Parameter(name = 'I2a33',
                  nature = 'internal',
                  type = 'real',
                  value = '0+ fmu3x3*Kq3x3',
                  texname = '\\text{I2a33}')
...
yt = Parameter(name = 'yt',
                  nature = 'internal',
                  type = 'real',
                  value = '2**0.75*fmu3x3*cmath.sqrt(Gf)',
                  texname = '\\text{yt}')
