...
function     reference_amp(vecs, scale2) result(xamp)
   ...
   prefactor0 = (1._ki_gol/36._ki_gol*real(NC, ki_gol))
   prefactor1 = (1._ki_gol/18._ki_gol*CF*real(NC, ki_gol))
   ...
   &6._ki_gol*t)*cmplx(gTv, 0.0_ki_gol, ki_gol)*cmplx(gev, 0.0_ki_gol, ki_gol)
   T27 = T34*64._ki_gol
   ...
   &gol)
   T44 = T14*cmplx(T2, 0.0_ki_gol, ki_gol)
   T45 = T14*cmplx(T3, 0.0_ki_gol, ki_gol)
   T49 = T34*144._ki_gol
   ...
   &gol+T38*192._ki_gol)*cmplx(T1, 0.0_ki_gol, ki_gol))*rho)*cmplx(gTa, 0.0_ki_g&
   &ol, ki_gol)*cmplx(gea, 0.0_ki_gol, ki_gol))*PZc+((T40-T26)*128._ki_gol+(T21*&
   &64._ki_gol+T42*rho)*cmplx(T1, 0.0_ki_gol, ki_gol)+(T24*256._ki_gol+T27+(T32*&
   &128._ki_gol+T41*256._ki_gol)*rho+T42*tau)*t)*rho+(T19+(((((T20*cmplx(T2, 0.0&
   &_ki_gol, ki_gol)+T20*cmplx(T3, 0.0_ki_gol, ki_gol))*t+(T48*cmplx(T2, 0.0_ki_&
   &gol, ki_gol)+T48*cmplx(T3, 0.0_ki_gol, ki_gol))*cmplx(T1, 0.0_ki_gol, ki_gol&
   &)+T15*cmplx(T2, 0.0_ki_gol, ki_gol)+T15*cmplx(T3, 0.0_ki_gol, ki_gol))*rho+T&
   &18*cmplx(T2, 0.0_ki_gol, ki_gol)+T18*cmplx(T3, 0.0_ki_gol, ki_gol))*cmplx(gT&
   &a, 0.0_ki_gol, ki_gol)+(((T14+T26+T21*t)*2._ki_gol+T22)*288._ki_gol+((T29*17&
   &28._ki_gol+T30*1152._ki_gol+T34*576._ki_gol)*cmplx(T1, 0.0_ki_gol, ki_gol)+(&
   &T32*576._ki_gol+T37*1728._ki_gol+T46)*t-T14*1152._ki_gol)*rho+(T37*1440._ki_&
   &gol+T46+T47)*cmplx(T1, 0.0_ki_gol, ki_gol))*cmplx(gTv, 0.0_ki_gol, ki_gol)*c&
   &mplx(gea, 0.0_ki_gol, ki_gol)*cmplx(gev, 0.0_ki_gol, ki_gol))*cmplx(gTa, 0.0&
   &_ki_gol, ki_gol)+((((-(T45+T44))*2._ki_gol*tau+(T44+T45)*rho)*288._ki_gol+((&
   &T21*cmplx(T2, 0.0_ki_gol, ki_gol)+T21*cmplx(T3, 0.0_ki_gol, ki_gol))*144._ki&
   &_gol+(T43*cmplx(T2, 0.0_ki_gol, ki_gol)+T43*cmplx(T3, 0.0_ki_gol, ki_gol))*r&
   &ho)*cmplx(T1, 0.0_ki_gol, ki_gol)+(T49*cmplx(T2, 0.0_ki_gol, ki_gol)+T49*cmp&
   &lx(T3, 0.0_ki_gol, ki_gol))*t)*rho+T17*cmplx(T2, 0.0_ki_gol, ki_gol)+T17*cmp&
   &lx(T3, 0.0_ki_gol, ki_gol))*cmplx(T4, 0.0_ki_gol, ki_gol))*PZc+(T28+(T35+T50&
   &)*cmplx(T1, 0.0_ki_gol, ki_gol)+(T39+(T25*192._ki_gol+T33)*cmplx(T1, 0.0_ki_&
   &gol, ki_gol)+(T36+T50)*t)*rho)*cmplx(gTa, 0.0_ki_gol, ki_gol)*cmplx(gea, 0.0&
   &_ki_gol, ki_gol))*PZ+(T32*32._ki_gol+T37*128._ki_gol+T38*64._ki_gol)*cmplx(T&
   &1, 0.0_ki_gol, ki_gol))
   T5 = prefactor1*rho
   T6 = 2._ki_gol*T5
   T7 = prefactor1*tau
   ...
   T11 = (96._ki_gol*(T5-T7)-48._ki_gol*prefactor1)*real(gTa, ki_gol)*real(gea, &
   &ki_gol)
   T6 = 48._ki_gol*(2._ki_gol*(T6-(prefactor1+T7))*tau-(prefactor1+T10))*real(gT&
   &v, ki_gol)*real(gev, ki_gol)
   ...
   &T12*real(T2, ki_gol)+T12*real(T3, ki_gol))*real(gTa, ki_gol)+(576._ki_gol*(T&
   &7-T5)+288._ki_gol*prefactor1)*real(gTv, ki_gol)*real(gea, ki_gol)*real(gev, &
   &ki_gol))*real(gTa, ki_gol)+72._ki_gol*(2._ki_gol*(real(T2, ki_gol)*T8+real(T&
   &3, ki_gol)*T8)*tau+T13*real(T2, ki_gol)+T13*real(T3, ki_gol))*real(T4, ki_go&
   &l))*PZc)*PZ)
   T5 = prefactor0*rho
   T6 = 2._ki_gol*T5
   T7 = prefactor0*tau
   ...
   T10 = (96._ki_gol*(T5-T7)-48._ki_gol*prefactor0)*real(gTa, ki_gol)*real(gea, &
   &ki_gol)
   T6 = 48._ki_gol*(2._ki_gol*(T6-(prefactor0+T7))*tau-(prefactor0+T9))*real(gTv&
   &, ki_gol)*real(gev, ki_gol)
   ...
   &11*real(T2, ki_gol)+T11*real(T3, ki_gol))*real(gTa, ki_gol)+(576._ki_gol*(T7&
   &-T5)+288._ki_gol*prefactor0)*real(gTv, ki_gol)*real(gea, ki_gol)*real(gev, k&
   &i_gol))*real(gTa, ki_gol)+72._ki_gol*(2._ki_gol*(real(T2, ki_gol)*T8+real(T3&
   &, ki_gol)*T8)*tau+T12*real(T2, ki_gol)+T12*real(T3, ki_gol))*real(T4, ki_gol&
   &))*PZc)*PZ)
   rmass_or_cmass_par = cmass
   nullify(s_mat)
   call deallocation_s()
