...
!---#[ function finite_renormalisation:
   ...
   function     samplitude(scale2,ok,rational2,the_col0,opt_perm)
     ...
     & only: init_lo, rat2
      use pc16_gghh_abbrevd33_1h0, only: init_abbrevd33 => init_abbrev
      use pc16_gghh_abbrevd5_1h0, only: init_abbrevd5 => init_abbrev
      use pc16_gghh_abbrevd12_1h0, only: init_abbrevd12 => init_abbrev
      use pc16_gghh_abbrevd14_1h0, only: init_abbrevd14 => init_abbrev
      use pc16_gghh_abbrevd31_1h0, only: init_abbrevd31 => init_abbrev
      use pc16_gghh_abbrevd1_1h0, only: init_abbrevd1 => init_abbrev
      use pc16_gghh_abbrevd2_1h0, only: init_abbrevd2 => init_abbrev
      use pc16_gghh_abbrevd3_1h0, only: init_abbrevd3 => init_abbrev
      use pc16_gghh_abbrevd4_1h0, only: init_abbrevd4 => init_abbrev
      use pc16_gghh_abbrevd7_1h0, only: init_abbrevd7 => init_abbrev
      use pc16_gghh_abbrevd8_1h0, only: init_abbrevd8 => init_abbrev
      use pc16_gghh_abbrevd10_1h0, only: init_abbrevd10 => init_abbrev
      use pc16_gghh_abbrevd16_1h0, only: init_abbrevd16 => init_abbrev
      use pc16_gghh_abbrevd18_1h0, only: init_abbrevd18 => init_abbrev
      use pc16_gghh_abbrevd22_1h0, only: init_abbrevd22 => init_abbrev
      use pc16_gghh_abbrevd23_1h0, only: init_abbrevd23 => init_abbrev
      use pc16_gghh_abbrevd27_1h0, only: init_abbrevd27 => init_abbrev
      use pc16_gghh_abbrevd29_1h0, only: init_abbrevd29 => init_abbrev
      use pc16_gghh_groups
      implicit none
      real(ki), intent(in) :: scale2
...
subroutine     evaluate_group0(scale2,samplitude,ok)
   ...
   use pc16_gghh_golem95_1h0, only: reconstruct_golem95 => reconstruct_group
...
!---#] subroutine evaluate_group2:
end module pc16_gghh_amplitudeh0_1
