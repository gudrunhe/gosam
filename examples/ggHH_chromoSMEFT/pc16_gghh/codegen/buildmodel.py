...
modelfile.write('module     pc16_gghh_model\n')
modelfile.write('   ! Model parameters for the model: FeynRules,../model/UFO_modHEFTchromo\n')
modelfile.write('   use pc16_gghh_config, only: ki')
modelfile.write(', &\n')
...
modelfile.write('   real(ki) :: mdlCtG =        1.000000000000000_ki\n')
...
modelfile.write('   complex(ki) :: mdlCtGGC51\n')
modelfile.write('   complex(ki) :: mdlCtGGC52\n')
modelfile.write('   complex(ki) :: mdlCtGGC53\n')
modelfile.write('   complex(ki) :: mdlCtGGC54\n')
...
modelfile.write("   write(unit,'(A1,1x,A11,G23.16)') \"#\", \"mdlCtG= \", mdlCtG\n")
...
modelfile.write("   write(unit,'(A1,1x,A11,\"(\",G23.16,G23.16,\")\",\" calc.\")') \"#\", \"mdlCtGGC51= \", mdlCtGGC51\n")

modelfile.write("   write(unit,'(A1,1x,A11,\"(\",G23.16,G23.16,\")\",\" calc.\")') \"#\", \"mdlCtGGC52= \", mdlCtGGC52\n")

modelfile.write("   write(unit,'(A1,1x,A11,\"(\",G23.16,G23.16,\")\",\" calc.\")') \"#\", \"mdlCtGGC53= \", mdlCtGGC53\n")

modelfile.write("   write(unit,'(A1,1x,A11,\"(\",G23.16,G23.16,\")\",\" calc.\")') \"#\", \"mdlCtGGC54= \", mdlCtGGC54\n")
...
modelfile.write("            case(1)\n")
modelfile.write("               mdlCtG = parsereal(value, ierr, lnr)\n")
modelfile.write("            case(2)\n")
...
modelfile.write("end module pc16_gghh_model\n")
