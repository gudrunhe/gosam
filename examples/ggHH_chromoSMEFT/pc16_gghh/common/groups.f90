...
function     contract_tensor_coefficients_group_0(coeffs) result(amp)
   ...
   use pc16_gghh_config, only: debug_nlo_diagrams, logfile
   use pc16_gghh_kinematics, only: k1, k2, k3, k4, es12, es4, es23, es3
   use pc16_gghh_model
   implicit none
