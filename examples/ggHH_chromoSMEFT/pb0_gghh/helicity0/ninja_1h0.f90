...
subroutine     ninja_reduce_group0(scale2,tot,totr,ok)
   ...
   use pb0_gghh_model
   use pb0_gghh_d13_1h0l1, only: numerator_diagram13 => numerator_ninja
   use pb0_gghh_d13_1h0l121, only: numerator_tmu_diagram13 => numerator_tmu
   use pb0_gghh_d13_1h0l131, only: numerator_t3_diagram13 => numerator_t3
   use pb0_gghh_d13_1h0l132, only: numerator_t2_diagram13 => numerator_t2
...
subroutine     ninja_reduce_group1(scale2,tot,totr,ok)
   ...
   use pb0_gghh_kinematics
   use pb0_gghh_model
   use pb0_gghh_d11_1h0l1, only: numerator_diagram11 => numerator_ninja
   use pb0_gghh_d11_1h0l121, only: numerator_tmu_diagram11 => numerator_tmu
   use pb0_gghh_d11_1h0l131, only: numerator_t3_diagram11 => numerator_t3
   use pb0_gghh_d11_1h0l132, only: numerator_t2_diagram11 => numerator_t2
   use pb0_gghh_globalsl1, only: epspow
...
subroutine     ninja_reduce_group2(scale2,tot,totr,ok)
   ...
   use pb0_gghh_kinematics
   use pb0_gghh_model
   use pb0_gghh_d2_1h0l1, only: numerator_diagram2 => numerator_ninja
   use pb0_gghh_d2_1h0l121, only: numerator_tmu_diagram2 => numerator_tmu
   use pb0_gghh_d2_1h0l131, only: numerator_t3_diagram2 => numerator_t3
   use pb0_gghh_d2_1h0l132, only: numerator_t2_diagram2 => numerator_t2
   use pb0_gghh_d7_1h0l1, only: numerator_diagram7 => numerator_ninja
   use pb0_gghh_d7_1h0l121, only: numerator_tmu_diagram7 => numerator_tmu
   use pb0_gghh_d7_1h0l131, only: numerator_t3_diagram7 => numerator_t3
   use pb0_gghh_d7_1h0l132, only: numerator_t2_diagram7 => numerator_t2
   use pb0_gghh_d9_1h0l1, only: numerator_diagram9 => numerator_ninja
   use pb0_gghh_d9_1h0l121, only: numerator_tmu_diagram9 => numerator_tmu
   use pb0_gghh_d9_1h0l131, only: numerator_t3_diagram9 => numerator_t3
   use pb0_gghh_d9_1h0l132, only: numerator_t2_diagram9 => numerator_t2
   use pb0_gghh_globalsl1, only: epspow
