...
f90file.write('module     pb0_gghh_'+diag_name[:-1]+'21\n')
...
f90file.write('   use pb0_gghh_util, only: cond_t, d => metric_tensor \n')
f90file.write('\n')
...
f90file.write('   & bind(c, name="pb0_gghh_d{0}h{1}_ninja_tmu")\n'.format(diag+'_0',heli) )
...
f90file.write('!---#] subroutine numerator_tmu: \n')
f90file.write('end module     pb0_gghh_'+diag_name[:-1]+'21\n')
f90file.close()
