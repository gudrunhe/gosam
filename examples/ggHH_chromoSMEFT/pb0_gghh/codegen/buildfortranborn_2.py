...
f90file.write('module     pb0_gghh_diagramsh'+str(heli)+'l0_2\n')
f90file.write('   ! file: '+str(os.getcwd())+'diagramsl0_2.f90 \n')
f90file.write('   ! generator: buildfortranborn.py \n')
f90file.write('   use pb0_gghh_color, only: numcs\n')
...
f90file.write('      use pb0_gghh_config, only: debug_lo_diagrams, &\n')
f90file.write('        & use_sorted_sum\n')
f90file.write('      use pb0_gghh_accu, only: sorted_sum\n')
f90file.write('      use pb0_gghh_util, only: inspect_lo_diagram\n')
f90file.write('      implicit none\n')
...
f90file.write('!---#] function amplitude:\n')
f90file.write('end module pb0_gghh_diagramsh'+str(heli)+'l0_2\n')
f90file.close()
