...
abbfile.write('module     pb0_gghh_abbrevd'+diag+'_1'+'h'+heli+'\n')
abbfile.write('   use pb0_gghh_config, only: ki\n')
abbfile.write('   use pb0_gghh_kinematics, only: epstensor\n')
abbfile.write('   use pb0_gghh_globals'+'h'+heli+'\n')
...
abbfile.write('      use pb0_gghh_config, only: deltaOS, &\n')
abbfile.write('     &    logfile, debug_nlo_diagrams\n')
abbfile.write('      use pb0_gghh_kinematics\n')
abbfile.write('      use pb0_gghh_model\n')
abbfile.write('      use pb0_gghh_color, only: TR\n')
abbfile.write('      use pb0_gghh_globalsl1, only: epspow\n')
abbfile.write('      implicit none\n')
abbfile.write('\n')
abb_chunks = []
line_counter = 0
...
abbfile.write('   end subroutine\n')
abbfile.write('end module pb0_gghh_abbrevd'+diag+'_1'+'h'+heli+'\n')
...
f90file.write('   use pb0_gghh_util, only: cond\n')
f90file.write('\n')
...
f90file.write('      use pb0_gghh_abbrevd'+diag+'_1'+'h'+heli+'\n')
f90file.write('      implicit none\n')
...
f90file.write('   & bind(c, name="pb0_gghh_'+diag_name+'_ninja")\n')
