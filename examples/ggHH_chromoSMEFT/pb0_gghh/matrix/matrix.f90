module     pb0_gghh_matrix
   use pb0_gghh_util, only: square
   use pb0_gghh_config, only: ki, &
     ...
     & EFTcount
   use pb0_gghh_kinematics, only: &
       in_helicities, symmetry_factor, num_legs, &
       lo_qcd_couplings, corrections_are_qcd, num_light_quarks, num_gluons
   use pb0_gghh_model, only: mdlEFTcount, Nf, NC, sqrt2, init_functions
   use pb0_gghh_color, only: TR, CA, CF, numcs, &
     & incolors, init_color
   use pb0_gghh_diagramsh0l0_0, only: amplitude0l0_0 => amplitude
   use pb0_gghh_diagramsh0l0_1, only: amplitude0l0_1 => amplitude
   use pb0_gghh_diagramsh0l0_2, only: amplitude0l0_2 => amplitude
   use pb0_gghh_amplitudeh0_0, only: samplitudeh0l1_0 => samplitude, &
     &   finite_renormalisation0_0 => finite_renormalisation
   use pb0_gghh_amplitudeh0_1, only: samplitudeh0l1_1 => samplitude, &
     &   finite_renormalisation0_1 => finite_renormalisation
   use pb0_gghh_amplitudeh0_2, only: samplitudeh0l1_2 => samplitude, &
     &   finite_renormalisation0_2 => finite_renormalisation
   use pb0_gghh_dipoles, only: insertion_operator, insertion_operator_qed
...
contains
   ...
   function     samplitudel0(vecs, h) result(amp)
      use pb0_gghh_config, only: logfile
      use pb0_gghh_kinematics, only: init_event
      implicit none
      real(ki), dimension(4, 4), intent(in) :: vecs
      ...
      if (eval_heli(0)) then
         ...
         case (0)
            ...
            color_vector_0 = amplitude0l0_0()
            color_vector_1 = amplitude0l0_1()
            ! color_vector_2 = amplitude0l0_2()
            ! heli_amp = square(color_vector_0) &
            !        & + square(color_vector_0,color_vector_1)
            heli_amp = square(color_vector_0) &
            & + square(color_vector_0, color_vector_1 - color_vector_0)
         case (1)
         ...
         case (2)
            ...
            color_vector_2 = amplitude0l0_2()
            heli_amp = square(color_vector_1) &
                   & + square(color_vector_0, color_vector_2 - color_vector_1)
         case (3)
   ...
   function     samplitudel1(vecs,scale2,ok,rat2,h) result(amp)
      ...
      if (eval_heli(0)) then
         ...
         case(0)
            ...
            amp0_0 = amplitude0l0_0()
            amp0_1 = amplitude0l0_1()
            ! amp0_2 = amplitude0l0_2()
            ! heli_amp = samplitudeh0l1_0(real(scale2,ki),my_ok,rational2,amp0_0+amp0_1) &
            ! &        + samplitudeh0l1_1(real(scale2,ki),my_ok,rational2,amp0_0)
            heli_amp = samplitudeh0l1_0(real(scale2,ki),my_ok,rational2,amp0_1 - amp0_0) &
            &        + samplitudeh0l1_1(real(scale2,ki),my_ok,rational2,amp0_0)
         case(1)
            ! sigma(SM + dim6 X SM + dim6)
            ! amp0_0 = amplitude0l0_0()
            ...
            ! amp0_2 = amplitude0l0_2()
            ! heli_amp = samplitudeh0l1_0(real(scale2,ki),my_ok,rational2,amp0_0+amp0_1) &
            ! &        + samplitudeh0l1_1(real(scale2,ki),my_ok,rational2,amp0_0+amp0_1)
            heli_amp = samplitudeh0l1_1(real(scale2,ki),my_ok,rational2,amp0_1)
         case(2)
            ! sigma(SM + dim6 X SM + dim6) + sigma(SM X SM + dim6^2)
            amp0_0 = amplitude0l0_0()
            amp0_1 = amplitude0l0_1()
            amp0_2 = amplitude0l0_2()
            ! heli_amp = samplitudeh0l1_0(real(scale2,ki),my_ok,rational2,amp0_0+amp0_1+amp0_2) &
            ! &        + samplitudeh0l1_1(real(scale2,ki),my_ok,rational2,amp0_0+amp0_1) &
            ! &        + samplitudeh0l1_2(real(scale2,ki),my_ok,rational2,amp0_0)
            heli_amp = samplitudeh0l1_0(real(scale2,ki),my_ok,rational2,amp0_2 - amp0_1) &
            &        + samplitudeh0l1_1(real(scale2,ki),my_ok,rational2,amp0_1 - amp0_0) &
            &        + samplitudeh0l1_2(real(scale2,ki),my_ok,rational2,amp0_0)
         case(3)
            ! sigma(SM + dim6 + dim6^2 X SM + dim6 + dim6^2)
            ! amp0_0 = amplitude0l0_0()
            ...
            amp0_2 = amplitude0l0_2()
            ! heli_amp = samplitudeh0l1_0(real(scale2,ki),my_ok,rational2,amp0_0+amp0_1+amp0_2) &
            ! &        + samplitudeh0l1_1(real(scale2,ki),my_ok,rational2,amp0_0+amp0_1+amp0_2) &
            ! &        + samplitudeh0l1_2(real(scale2,ki),my_ok,rational2,amp0_0+amp0_1+amp0_2)
            heli_amp = samplitudeh0l1_2(real(scale2,ki),my_ok,rational2,amp0_2)
         end select
   ...
   pure function square_1_2_sc(color_vector1, color_vector2) result(amp)
      use pb0_gghh_color, only: cmat => T1T2
