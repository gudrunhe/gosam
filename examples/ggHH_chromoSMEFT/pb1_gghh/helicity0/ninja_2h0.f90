...
subroutine     ninja_reduce_group0(scale2,tot,totr,ok)
   ...
   use pb1_gghh_model
   use pb1_gghh_d13_2h0l1, only: numerator_diagram13 => numerator_ninja
   use pb1_gghh_d13_2h0l121, only: numerator_tmu_diagram13 => numerator_tmu
   use pb1_gghh_d13_2h0l131, only: numerator_t3_diagram13 => numerator_t3
   use pb1_gghh_d13_2h0l132, only: numerator_t2_diagram13 => numerator_t2
...
subroutine     ninja_reduce_group1(scale2,tot,totr,ok)
   ...
   use pb1_gghh_kinematics
   use pb1_gghh_model
   use pb1_gghh_d11_2h0l1, only: numerator_diagram11 => numerator_ninja
   use pb1_gghh_d11_2h0l121, only: numerator_tmu_diagram11 => numerator_tmu
   use pb1_gghh_d11_2h0l131, only: numerator_t3_diagram11 => numerator_t3
   use pb1_gghh_d11_2h0l132, only: numerator_t2_diagram11 => numerator_t2
   use pb1_gghh_globalsl1, only: epspow
...
subroutine     ninja_reduce_group2(scale2,tot,totr,ok)
   ...
   use pb1_gghh_kinematics
   use pb1_gghh_model
   use pb1_gghh_d2_2h0l1, only: numerator_diagram2 => numerator_ninja
   use pb1_gghh_d2_2h0l121, only: numerator_tmu_diagram2 => numerator_tmu
   use pb1_gghh_d2_2h0l131, only: numerator_t3_diagram2 => numerator_t3
   use pb1_gghh_d2_2h0l132, only: numerator_t2_diagram2 => numerator_t2
   use pb1_gghh_d7_2h0l1, only: numerator_diagram7 => numerator_ninja
   use pb1_gghh_d7_2h0l121, only: numerator_tmu_diagram7 => numerator_tmu
   use pb1_gghh_d7_2h0l131, only: numerator_t3_diagram7 => numerator_t3
   use pb1_gghh_d7_2h0l132, only: numerator_t2_diagram7 => numerator_t2
   use pb1_gghh_d9_2h0l1, only: numerator_diagram9 => numerator_ninja
   use pb1_gghh_d9_2h0l121, only: numerator_tmu_diagram9 => numerator_tmu
   use pb1_gghh_d9_2h0l131, only: numerator_t3_diagram9 => numerator_t3
   use pb1_gghh_d9_2h0l132, only: numerator_t2_diagram9 => numerator_t2
   use pb1_gghh_globalsl1, only: epspow
