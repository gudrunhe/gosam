...
abbfile.write('module     pb1_gghh_abbrevd'+diag+'_2'+'h'+heli+'\n')
...
abbfile.write('   end subroutine\n')
abbfile.write('end module pb1_gghh_abbrevd'+diag+'_2'+'h'+heli+'\n')
...
f90file.write('      use pb1_gghh_abbrevd'+diag+'_2'+'h'+heli+'\n')
f90file.write('      implicit none\n')
...
if int(heli) == -1:
    shutil.move(abb_tmpname,'abbrevd'+diag+'_2.f90')
else:
    shutil.move(abb_tmpname,'abbrevd'+diag+'_2h'+heli+'.f90')
