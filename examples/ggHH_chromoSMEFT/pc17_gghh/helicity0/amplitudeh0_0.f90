...
!---#[ function finite_renormalisation:
   function     finite_renormalisation(scale2) result(amp)
      ...
      use pc17_gghh_diagramsh0l0_0, only: amplitudel0 => amplitude
      implicit none
   ...
   function     samplitude(scale2,ok,rational2,opt_amp0,opt_perm)
     ...
     & only: init_lo, rat2
      use pc17_gghh_abbrevd33_0h0, only: init_abbrevd33 => init_abbrev
      use pc17_gghh_abbrevd5_0h0, only: init_abbrevd5 => init_abbrev
      use pc17_gghh_abbrevd12_0h0, only: init_abbrevd12 => init_abbrev
      use pc17_gghh_abbrevd14_0h0, only: init_abbrevd14 => init_abbrev
      use pc17_gghh_abbrevd31_0h0, only: init_abbrevd31 => init_abbrev
      use pc17_gghh_abbrevd1_0h0, only: init_abbrevd1 => init_abbrev
      use pc17_gghh_abbrevd2_0h0, only: init_abbrevd2 => init_abbrev
      use pc17_gghh_abbrevd3_0h0, only: init_abbrevd3 => init_abbrev
      use pc17_gghh_abbrevd4_0h0, only: init_abbrevd4 => init_abbrev
      use pc17_gghh_abbrevd7_0h0, only: init_abbrevd7 => init_abbrev
      use pc17_gghh_abbrevd8_0h0, only: init_abbrevd8 => init_abbrev
      use pc17_gghh_abbrevd10_0h0, only: init_abbrevd10 => init_abbrev
      use pc17_gghh_abbrevd16_0h0, only: init_abbrevd16 => init_abbrev
      use pc17_gghh_abbrevd18_0h0, only: init_abbrevd18 => init_abbrev
      use pc17_gghh_abbrevd22_0h0, only: init_abbrevd22 => init_abbrev
      use pc17_gghh_abbrevd23_0h0, only: init_abbrevd23 => init_abbrev
      use pc17_gghh_abbrevd27_0h0, only: init_abbrevd27 => init_abbrev
      use pc17_gghh_abbrevd29_0h0, only: init_abbrevd29 => init_abbrev
      use pc17_gghh_diagramsh0l0_0, only: amplitudel0 => amplitude
      use pc17_gghh_groups
      implicit none
      real(ki), intent(in) :: scale2
...
subroutine     evaluate_group0(scale2,samplitude,ok)
   ...
   use pc17_gghh_golem95_0h0, only: reconstruct_golem95 => reconstruct_group
...
!---#] subroutine evaluate_group2:
end module pc17_gghh_amplitudeh0_0
