...
colorfile.write('module     pc17_gghh_color\n')
colorfile.write('   ! file: '+str(os.getcwd())+'/color.f90 \n')
colorfile.write('   ! generator: buildcolor.py\n')
colorfile.write('   use pc17_gghh_config, only: ki\n')
colorfile.write('   use pc17_gghh_model, only: NC, Nf\n')
...
colorfile.write('end module pc17_gghh_color\n')
