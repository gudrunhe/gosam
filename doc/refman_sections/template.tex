...
\\Hidden: \verb|False|
\\Experimental: \verb|False|
\\\item[\colorbox{gray!30}{\texttt{massive\_light\_fermions}}] (\textit{true/false})
\begin{verbatim}
...
\\Hidden: \verb|False|
\\Experimental: \verb|False|
\\\item[\colorbox{gray!30}{\texttt{filter.options}}] (\textit{comma separated list})
\begin{verbatim}
...
\\Hidden: \verb|False|
\\Experimental: \verb|False|
\\\item[\colorbox{gray!30}{\texttt{diagram\_selector}}] (\textit{text})
\begin{verbatim}
...
\\Hidden: \verb|False|
\\Experimental: \verb|False|
\\\item[\colorbox{gray!30}{\texttt{diagram\_selector.lo}}] (\textit{text})
\begin{verbatim}
...
\\Hidden: \verb|False|
\\Experimental: \verb|False|
\\\item[\colorbox{gray!30}{\texttt{diagram\_selector.nlo}}] (\textit{text})
\begin{verbatim}
...
\\Hidden: \verb|False|
\\Experimental: \verb|False|
\\\item[\colorbox{gray!30}{\texttt{diagram\_selector.ct}}] (\textit{text})
\begin{verbatim}
...
\\Hidden: \verb|False|
\\Experimental: \verb|False|
\\\item[\colorbox{gray!30}{\texttt{filter}}] (\textit{text})
\begin{verbatim}
...
filter=lambda d: sum(p.name() == "Z" for p in d.propagators()) == 1       and not any(v.match_particles(["Z", "U", "Ubar"]) for v in d.vertices())
\end{verbatim}
Default: \verb|""|
\\Hidden: \verb|False|
\\Experimental: \verb|False|
...
\\Hidden: \verb|False|
\\Experimental: \verb|False|
\\\item[\colorbox{gray!30}{\texttt{PSP\_chk\_rotdiff}}] (\textit{text})
\begin{verbatim}
Sets the same variable in config.f90
...
\\Hidden: \verb|False|
\\Experimental: \verb|False|
\\\item[\colorbox{gray!30}{\texttt{PSP\_chk\_kfactor\_li}}] (\textit{text})
\begin{verbatim}
Sets the same variable in config.f90
...
\\Hidden: \verb|False|
\\Experimental: \verb|False|
\\\item[\colorbox{gray!30}{\texttt{PSP\_chk\_rotdiff\_li}}] (\textit{text})
\begin{verbatim}
Sets the same variable in config.f90
