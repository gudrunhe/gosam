...
For loop-induced processes, the stability and rescue procedure are
...
\begin{figure}
    \includegraphics[width=\textwidth]{figures/PSP_Check.pdf}
...
\begin{figure}
    \includegraphics[width=\textwidth]{figures/PSP_Rescue.pdf}
