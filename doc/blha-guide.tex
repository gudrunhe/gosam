...
\attention{Please note that \gosam will ignore the BLHA2 optional keyword \texttt{MassiveParticles} as this can result in unintended behaviour depending on the used physics model. If the user wishes to set any particle masses to zero, this should be done by means of the ``\texttt{zero}'' option in the process card.}
