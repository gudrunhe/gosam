...
\newcommand{\golem}{\textsc{Golem95}\xspace}
...
\newcommand{\oneloop}{\textsc{OneLOop}\xspace}
...
\hypersetup{%
	pdfborder={0 0 0},%
	pdftitle={GoSam-\gosamversion\xspace Manual},%
...
\input{refman_sections/renormalisation.tex}
