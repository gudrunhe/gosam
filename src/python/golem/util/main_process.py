...
#from golem.util.main_helicity import rewrite_helicity_legs
...
def create_process_hh(conf, in_particles, out_particles):
	...
	#f.write("*---#[ color :\n")
	# OBSOLETE_write_color_basis(f, in_particles, out_particles)
...
def OBSOLETE_generate_abbrev_proc(conf, in_particles, out_particles, max_power=-1):
	"""
