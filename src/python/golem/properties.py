...
config_PSP_chk_th5 = Property("PSP_chk_th5",
   """\
   Sets the same variable in config.f90
...
config_PSP_chk_th6 = Property("PSP_chk_th6",
   """\
   Sets the same variable in config.f90
...
config_PSP_chk_li5 = Property("PSP_chk_li5",
   """\
   Sets the same variable in config.f90
...
config_PSP_chk_li6 = Property("PSP_chk_li6",
   """\
   Sets the same variable in config.f90
