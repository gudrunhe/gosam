...
\noindent This process consists of [% @select topolopy.count.tree
 ...
 @end @select %] and [% @select topolopy.count.virt
 @case 0 %]no NLO diagrams[%
 @case 1 %]one NLO diagram[%
 @else %][% topolopy.count.virt %] NLO diagrams[%
 @end @select %]. Golem has identified [% @select count groups
 ...
 @if renorm
   %] There are [% @select diagrams.2
 @case 0 %]no counterterms[%
 @case 1 %]one counter term[%
 @else %][%diagrams.1%] counter terms[%
...
\begin{align}[%
@for latex_color_base %]
\vert c_{[% $_ %]}\rangle &= [% expr %][%
