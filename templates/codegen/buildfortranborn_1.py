...
f90file.write('module     [% process_name asprefix=\_ %]diagramsh'+str(heli)+'l0_1\n')
...
f90file.write('!---#] function amplitude:\n')
f90file.write('end module [% process_name asprefix=\_ %]diagramsh'+str(heli)+'l0_1\n')
f90file.close()
[% @if extension quadruple %]
f90file_qp.write('module     [% process_name asprefix=\_ %]diagramsh'+str(heli)+'l0_1_qp\n')
f90file_qp.write('   ! file: '+str(os.getcwd())+'diagramsl0_1_qp.f90 \n')
f90file_qp.write('   ! generator: buildfortranborn_1.py \n')
...
f90file_qp.write('!---#] function amplitude:\n')
f90file_qp.write('end module [% process_name asprefix=\_ %]diagramsh'+str(heli)+'l0_1_qp\n')
f90file_qp.close()
[% @end @if extension quadruple %]
txtfile.close()
...
[% @if extension quadruple %]
shutil.move(tmpname_qp,'diagramsl0_1_qp.f90')
[% @end @if extension quadruple %]
