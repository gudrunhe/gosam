...
for irank in range(1,rank+2):
	...
	f90file.write('      use [% process_name asprefix=\_ %]abbrevd'+diag+'_0'[% @if helsum %][% @else %]+'h'+heli[% @end @if %]+'\n')
	f90file.write('      implicit none \n')
...
for irank in range(1,rank+2):
	...
	f90file_qp.write('      use [% process_name asprefix=\_ %]abbrevd'+diag+'_0'[% @if helsum %][% @else %]+'h'+heli[% @end @if %]+'_qp\n')
	f90file_qp.write('      implicit none \n')
