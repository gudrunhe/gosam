...
f90file.write('   ! generator: buildfortraneftct[% @if use_order_names %]_[% trnco %][% @end @if %].py \n')
...
newabbr = re.sub(r"mdl([a-zA-Z0-9]*)eftctcpl",r"(mdl\1const(ii)+eftlog*mdl\1log(ii))",newabbr)
