...
f90file.write('   private :: bornamplitude, reglog, yukctOS, yukctMSbar\n')
f90file.write('\n')
...
f90file.write('\n')
f90file.write('      amplitude = bornamplitude(.false., .false., -1.0_ki, 0)\n')
f90file.write('\n')
f90file.write('   end function     amplitude\n')
f90file.write('!---#] function amplitude:\n')
f90file.write('!---#[ function amplitude_yukren:\n')
f90file.write('   function amplitude_yukren(logs, scale2, eps)\n')
f90file.write('      implicit none\n')
...
f90file.write('\n')
f90file.write('      amplitude_yukren = bornamplitude(.true., logs, scale2, eps)\n')
f90file.write('\n')
f90file.write('   end function     amplitude_yukren\n')
f90file.write('!---#] function amplitude_yukren:\n')
f90file.write('!---#[ function bornamplitude:\n')
f90file.write('   function bornamplitude(renorm_yuk, logs, scale2, eps) result(amplitude)\n')
...
f90file.write('      real(ki) :: CYUKAWA, scale2\n')
...
f90file.write('\n')
f90file.write('\n')
newabbr = re.sub(r"DELTAYUKOS([a-zA-Z0-9]*)",r"yukctOS(eps,logs,scale2/\1/\1)",outdict['Abbreviations'])
newabbr = re.sub(r"DELTAYUKMSbar([a-zA-Z0-9]*)",r"yukctMSbar(eps)",newabbr)
...
f90file.write('   function yukctOS(eps,logs,r)\n')
...
f90file.write('   function yukctMSbar(eps)\n')
f90file.write('      use [% process_name asprefix=\_ %]color, only: CF\n')
f90file.write('      implicit none\n')
...
f90file_qp.write('   private :: bornamplitude, reglog, yukctOS, yukctMSbar\n')
f90file_qp.write('\n')
...
f90file_qp.write('\n')
f90file_qp.write('      amplitude = bornamplitude(.false., .false., -1.0_ki, 0)\n')
f90file_qp.write('\n')
f90file_qp.write('   end function     amplitude\n')
f90file_qp.write('!---#] function amplitude:\n')
f90file_qp.write('!---#[ function amplitude_yukren:\n')
f90file_qp.write('   function amplitude_yukren(logs, scale2, eps)\n')
f90file_qp.write('      implicit none\n')
...
f90file_qp.write('\n')
f90file_qp.write('      amplitude_yukren = bornamplitude(.true., logs, scale2, eps)\n')
f90file_qp.write('\n')
f90file_qp.write('   end function     amplitude_yukren\n')
f90file_qp.write('!---#] function amplitude_yukren:\n')
f90file_qp.write('!---#[ function bornamplitude:\n')
f90file_qp.write('   function bornamplitude(renorm_yuk, logs, scale2, eps) result(amplitude)\n')
...
f90file_qp.write('      real(ki) :: CYUKAWA, scale2\n')
...
f90file_qp.write('   function yukctOS(eps,logs,r)\n')
...
f90file_qp.write('   function yukctMSbar(eps)\n')
f90file_qp.write('      use [% process_name asprefix=\_ %]color_qp, only: CF\n')
f90file_qp.write('      implicit none\n')
