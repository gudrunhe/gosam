...
f90file.write('        & use_sorted_sum, renormalisation, renorm_logs, &\n')
f90file.write('        & renorm_mqse, renorm_yukawa\n')
...
f90file.write('\n')
f90file.write('\n')
newabbr = re.sub(r"DELTAYUKOS([a-zA-Z0-9]*)",r"yukctOS(renorm,eps,scale2,\1)",outdict['Abbreviations'])
newabbr = re.sub(r"DELTAYUKMSbar([a-zA-Z0-9]*)",r"yukctMSbar(renorm,eps)",newabbr)
newabbr = re.sub(r"DELTAMASSOS([a-zA-Z0-9]*)",r"massctOS(renorm,eps,scale2,\1)",newabbr)
...
f90file_qp.write('        & use_sorted_sum, renormalisation, renorm_logs, &\n')
f90file_qp.write('        & renorm_mqse, renorm_yukawa\n')
