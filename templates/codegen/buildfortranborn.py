...
f90file.write('        & renorm_qmass, renorm_yukawa, renorm_gamma5\n')
...
f90file.write('               if (renorm_qmass) then\n')
...
f90file_qp.write('        & renorm_qmass, renorm_yukawa, renorm_gamma5\n')
...
f90file_qp.write('               if (renorm_qmass) then\n')
