...
f90file.write('\n')
f90file.write('      amplitude = bornamplitude(.false., .false., -1.0_ki)\n')
f90file.write('\n')
f90file.write('   end function     amplitude\n')
f90file.write('!---#] function amplitude:\n')
f90file.write('!---#[ function amplitude_yukren:\n')
f90file.write('   function amplitude_yukren(logs, scale2)\n')
f90file.write('      implicit none\n')
f90file.write('      complex(ki), dimension(numcs) :: amplitude_yukren\n')
f90file.write('      real(ki) :: scale2\n')
f90file.write('      logical :: logs\n')
f90file.write('\n')
f90file.write('      amplitude_yukren = bornamplitude(.true., logs, scale2)\n')
f90file.write('\n')
f90file.write('   end function     amplitude_yukren\n')
f90file.write('!---#] function amplitude_yukren:\n')
...
f90file.write('      real(ki) :: CYUKAWA, RENLOG, scale2\n')
f90file.write('      logical :: renorm_yuk, logs\n')
f90file.write('\n')
f90file.write('      if (renorm_yuk) then\n')
...
f90file.write('         RENLOG = 1.0_ki\n')
f90file.write('      else\n')
f90file.write('         RENLOG = 0.0_ki\n')
f90file.write('      end if\n')
f90file.write('\n')
f90file.write('      amplitude(:) = 0.0_ki\n')
f90file.write('\n')
f90file.write('\n')
newabbr = re.sub(r"LOGYUK([a-zA-Z0-9]*)",r"reglog(scale2/\1/\1)",outdict['Abbreviations'])
...
f90file_qp.write('   private :: bornamplitude, reglog\n')
f90file_qp.write('\n')
...
f90file_qp.write('   public :: amplitude, amplitude_yukren\n')
f90file_qp.write('\n')
...
f90file_qp.write('\n')
f90file_qp.write('      amplitude = bornamplitude(.false., .false., -1.0_ki)\n')
f90file_qp.write('\n')
f90file_qp.write('   end function     amplitude\n')
f90file_qp.write('!---#] function amplitude:\n')
f90file_qp.write('!---#[ function amplitude_yukren:\n')
f90file_qp.write('   function amplitude_yukren(logs, scale2)\n')
f90file_qp.write('      implicit none\n')
f90file_qp.write('      complex(ki), dimension(numcs) :: amplitude_yukren\n')
f90file_qp.write('      real(ki) :: scale2\n')
f90file_qp.write('      logical :: logs\n')
f90file_qp.write('\n')
f90file_qp.write('      amplitude_yukren = bornamplitude(.true., logs, scale2)\n')
f90file_qp.write('\n')
f90file_qp.write('   end function     amplitude_yukren\n')
f90file_qp.write('!---#] function amplitude_yukren:\n')
...
f90file_qp.write('      real(ki) :: CYUKAWA, RENLOG, scale2\n')
f90file_qp.write('      logical :: renorm_yuk, logs\n')
f90file_qp.write('\n')
f90file_qp.write('      if (renorm_yuk) then\n')
...
f90file_qp.write('         RENLOG = 1.0_ki\n')
f90file_qp.write('      else\n')
f90file_qp.write('         RENLOG = 0.0_ki\n')
f90file_qp.write('      end if\n')
f90file_qp.write('\n')
