        ...
        #Else
                Repeat;
                        Id Spaa(vDUMMY1?, ?head, vDUMMY3?{`?vectors',}, ?tail, vDUMMY2?) =
                                (delta_(1-((1-mod_(nargs_(?head),2)))) * (Spaa(vDUMMY1, ?head, vDUMMY3) * Spba(vDUMMY3, ?tail, vDUMMY2)) + delta_((1-mod_(nargs_(?head),2))) * (Spab(vDUMMY1, ?head, vDUMMY3) * Spaa(vDUMMY3, ?tail, vDUMMY2)));
                        Id Spab(vDUMMY1?, ?head, vDUMMY3?{`?vectors',}, ?tail, vDUMMY2?) =
                                (delta_(1-((1-mod_(nargs_(?head),2)))) * (Spaa(vDUMMY1, ?head, vDUMMY3) * Spbb(vDUMMY3, ?tail, vDUMMY2)) + delta_((1-mod_(nargs_(?head),2))) * (Spab(vDUMMY1, ?head, vDUMMY3) * Spab(vDUMMY3, ?tail, vDUMMY2)));
                        Id Spba(vDUMMY1?, ?head, vDUMMY3?{`?vectors',}, ?tail, vDUMMY2?) =
                                (delta_(1-((1-mod_(nargs_(?head),2)))) * (Spbb(vDUMMY1, ?head, vDUMMY3) * Spaa(vDUMMY3, ?tail, vDUMMY2)) + delta_((1-mod_(nargs_(?head),2))) * (Spba(vDUMMY1, ?head, vDUMMY3) * Spba(vDUMMY3, ?tail, vDUMMY2)));
                        Id Spbb(vDUMMY1?, ?head, vDUMMY3?{`?vectors',}, ?tail, vDUMMY2?) =
                                (delta_(1-((1-mod_(nargs_(?head),2)))) * (Spbb(vDUMMY1, ?head, vDUMMY3) * Spab(vDUMMY3, ?tail, vDUMMY2)) + delta_((1-mod_(nargs_(?head),2))) * (Spba(vDUMMY1, ?head, vDUMMY3) * Spbb(vDUMMY3, ?tail, vDUMMY2)));
...
#Procedure RemoveNCContainer()
        ...
        Repeat;
                Id NCContainer(sDUMMY1?, iDUMMY1?, iDUMMY2?) *
                                NCContainer(sDUMMY2?, iDUMMY2?, iDUMMY3?) =
                        NCContainer(sDUMMY1 * sDUMMY2, iDUMMY1, iDUMMY3);
                #IfNDef `NOSPFLIP'
                        Id NCContainer(sDUMMY1?, iDUMMY1?, iDUMMY2?) *
                                        NCContainer(sDUMMY2?, iDUMMY3?, iDUMMY2?) =
                                NCContainer(sDUMMY1 * SpFlip(sDUMMY2), iDUMMY1, iDUMMY3);
                        Id NCContainer(sDUMMY1?, iDUMMY1?, iDUMMY2?) *
                                        NCContainer(sDUMMY2?, iDUMMY1?, iDUMMY3?) =
                                NCContainer(SpFlip(sDUMMY1) * sDUMMY2, iDUMMY2, iDUMMY3);
                #EndIf
        EndRepeat;
        Id NCContainer(sDUMMY1?, iDUMMY1?) *
                        NCContainer(sDUMMY2?, iDUMMY1?, iDUMMY2?) =
                NCContainer(sDUMMY1 * sDUMMY2, 0, iDUMMY2);
        Id NCContainer(sDUMMY1?, 0, iDUMMY1?) *
                        NCContainer(sDUMMY2?, iDUMMY1?) =
                NCContainer(sDUMMY1 * sDUMMY2);
        Id NCContainer(sDUMMY1?, 0, iDUMMY1?) *
                        NCContainer(sDUMMY2?, 0, iDUMMY1?) =
                NCContainer(sDUMMY1 * SpFlip(sDUMMY2));
        Id NCContainer(sDUMMY1?, iDUMMY1?, iDUMMY1?) =
                NCContainer(trL * sDUMMY1 * trR);
        Id NCContainer(fDUMMY1?{UbarSpa,UbarSpb}(?all1), iDUMMY1?) *    
               NCContainer(fDUMMY2?{USpa,USpb}(?all2), iDUMMY1?) =
                NCContainer(fDUMMY1(?all1) * fDUMMY2(?all2));
        Id NCContainer(fDUMMY1?{UbarSpa,UbarSpb,USpa,USpb}(?all1), iDUMMY1?) *  
        ...
        #IfNDef `NOSPFLIP'
                ...
                Id NCContainer(?head, fDUMMY2?{UbarSpa,UbarSpb}(?all2)) =
                        NCContainer(?head, SpFlip(fDUMMY2(?all2)));
                Id NCContainer(fDUMMY2?{USpa,USpb}(?all2), ?tail) =
                        NCContainer(SpFlip(fDUMMY2(?all2)), ?tail);
                ...
                Repeat Id SpFlip(SpFlip(sDUMMY1?)) = sDUMMY1;
                Repeat;
                        ...
                        #Do Sm={Sm,Sm4,SmEps}
                           Id SpFlip(`Sm'(iDUMMY1?)) = - `Sm'(iDUMMY1);
                        #EndDo
                        Id SpFlip(nDUMMY1?{Gamma5,ProjPlus,ProjMinus}) = nDUMMY1;
                        Id SpFlip(sDUMMY1?symbol_, ?tail) = sDUMMY1;
                        Id SpFlip(sDUMMY1?number_, ?tail) = sDUMMY1;
                EndRepeat;
        #Else
                Id NCContainer(sDUMMY1?) = sDUMMY1;
        #EndIf
