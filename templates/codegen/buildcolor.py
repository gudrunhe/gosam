...
colorfile.write('   use config, only: ki\n')
colorfile.write('   use model, only: NC, Nf\n')
...
colorfile_qp.write('   use config, only: ki => ki_qp\n')
colorfile_qp.write('   use model_qp, only: NC, Nf\n')
