...
colorfile.write('   use [$ @if internal OLP_MODE $][$ @else $][$ process_name$]_[$ @end @if $]config, only: ki\n')
colorfile.write('   use [$ @if internal OLP_MODE $][$ @else $][$ process_name$]_[$ @end @if $]model, only: NC, Nf\n')
...
colorfile_qp.write('   use [$ @if internal OLP_MODE $][$ @else $][$ process_name$]_[$ @end @if $]config, only: ki => ki_qp\n')
colorfile_qp.write('   use [$ @if internal OLP_MODE $][$ @else $][$ process_name$]_[$ @end @if $]model_qp, only: NC, Nf\n')
