...
model_name = "Standard Model in Feynman Gauge (Diagonal CKM) with no Higgs coupling to light quarks and massless light quarks"
#---#[ particles:
particles = {
   'U':       Particle('U',        1,   '0',  3, 'Ubar',  '0',        2,     2.0),
   'Ubar':    Particle('Ubar',    -1,   '0', -3, 'U',     '0',       -2,     2.0),
   'D':       Particle('D',        1,   '0',  3, 'Dbar',  '0',        1,    -1.0),
   'Dbar':    Particle('Dbar',    -1,   '0', -3, 'D',     '0',       -1,    -1.0),
   'S':       Particle('S',        1,   '0',  3, 'Sbar',  '0',        3,    -1.0),
   'Sbar':    Particle('Sbar',    -1,   '0', -3, 'S',     '0',       -3,    -1.0),
   'C':       Particle('C',        1,   '0',  3, 'Cbar',  '0',        4,     2.0),
   'Cbar':    Particle('Cbar',    -1,   '0', -3, 'C',     '0',       -4,     2.0),
