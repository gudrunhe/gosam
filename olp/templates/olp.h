 ...
 *             born part, and as fourth component the square of the born
 *             matrix element.
 *  \param status status of accuracy check: 1 passed, 0 did not pass.
 *
 *  The OLP generated by golem-2.0 will set the born matrix element square
 *  to a negative value to indicate an error during the evaluation of either
 *  the born or the virtual matrix element.
 */
void [% olp.process_name asprefix=\_ %]OLP_EvalSubProcess2(int l, double* mom, double mu, double* r, int* status);
[% @end @if %]
